...
ggplot(topone_df, aes(x = Year, y = Share)) +
  geom_line(color = "darkgreen", size = 1) +
  geom_point(size = 1) +
  labs(title = "(Wealth Share of Top One)",
       x = "Year", y = "Percent") +
  theme_minimal()

ggplot(topten_df, aes(x = Year, y = Share)) +
  geom_line(color = "darkgreen", size = 1) +
  geom_point(size = 1) +
  labs(title = "(Wealth Share of Top Ten)",
       x = "Year", y = "Percent") +
  theme_minimal()

ggplot(bothalf_df, aes(x = Year, y = Share)) +
  geom_line(color = "darkgreen", size = 1) +
  geom_point(size = 1) +
  labs(title = "(Wealth Share of Bottom Half )",
       x = "Year", y = "Percent") +
  theme_minimal()

ggplot(inflationrate_df, aes(x = observation_date, y = FPCPITOTLZGUSA)) +
  geom_line(color = "darkgreen", size = 1) +
  geom_point(size = 1) +
  labs(title = "(Wealth Share of Bottom Half )",
       x = "Year", y = "Percent") +
